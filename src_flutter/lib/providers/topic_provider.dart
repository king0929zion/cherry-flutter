...
// 当前话题提供者
class CurrentTopicNotifier extends Notifier<TopicModel?> {
  @override
  TopicModel? build() => null;
...
final currentTopicProvider = NotifierProvider<CurrentTopicNotifier, TopicModel?>(CurrentTopicNotifier.new);
